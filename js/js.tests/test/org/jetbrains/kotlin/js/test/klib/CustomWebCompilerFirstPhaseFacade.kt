...
class CustomWebCompilerFirstPhaseFacade(testServices: TestServices) : CustomKlibCompilerFirstPhaseFacade(testServices) {
    ...
    override fun compileKlib(
        ...
        if (exitCode == ExitCode.OK) {
            ...
            val messageCollector = testServices.compilerConfigurationProvider.getCompilerConfiguration(module).messageCollector
            messageCollector.report(CompilerMessageSeverity.ERROR, "Compilation failed: $exitCode")
            return null
        }
    }
}
